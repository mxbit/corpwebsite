...
$(document).ready(function() {   
   ...
   // $("body").append($colorsHTML);  
    ...
    $('.imgWrapper').children('img').addClass('imgWrapper_filter');
});
...
window.onload = function () { "use strict"; gaSSDSLoad("UA-29621914-1"); }; //load after page onload
/*************** REPLACE WITH YOUR OWN UA NUMBER ***********/
...
$(document).ready(function() {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */  
    $('#verifyImg').attr('src','captcha/captcha.php?'+Math.random());
    $("#refreshSecret").click(function(e)   {
        $('#verifyImg').attr('src','captcha/captcha.php?'+Math.random());
        e.preventDefault();
    });
    ...
    //     var sdata = {n:$("#name").val(), e:$("#email").val(), p:$("#phone").val(), c:$("#comments").val(), v:$("#verify").val()}
    //     if( sdata.n !="" && sdata.e !="" && sdata.p !="" && sdata.c !="" && sdata.v !="" )  {
    //         $.ajax({ url: "captcha/test.php", type: "POST", data: sdata, dataType: "json",
    ...
    if($('.imgHover').length){
        ...
        $('.imgHover article').hover(
            function () {
                ...
                var $this=$(this);
console.log()
                $this.find('.imgWrapper').children('img').removeClass('imgWrapper_filter');
                $this.find('.imgWrapper').children('img').addClass('imgWrapper_normal');
                ...
                $this.find('.imgWrapper').children('img').removeClass('imgWrapper_normal');
                 $this.find('.imgWrapper').children('img').addClass('imgWrapper_filter');
...
function initialize(id) {
    "use strict";
    var image = {url:'images/mxbit_marker.png'}

    var overlayTitle = 'Agencies';

    var locations = [
        //point number 1
        ['MXBIT Technology Innovations', 'HSR Layout, Bangalore',12.9192, 77.6534],

        //point number 2
        ['MXBIT Innovations Center', 'Trivandrum', 8.487726, 76.963840]
